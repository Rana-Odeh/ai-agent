...
schema_run_python_file = {
    ...
    "function": {
        ...
        "description": "Executes a Python file inside the working directory with optional arguments",
        "parameters": {
            "type": "object",
            "properties": {
                "file_path": {
                ...
                "args": {
                    "type": "array",
                    "items": {"type": "string"},
                    "description": "Optional command-line arguments for the Python script",
                },
            },
            "required": ["file_path"],
        },
